...
class MyAccountManager(BaseUserManager):
    ...
    def create_superuser(self, email, username, first_name, last_name, phone_number, password):
        ...
        user.is_active = True
        user.is_staff = True
        user.is_superuser = True   # ✅ spelling fix
        user.save(using=self._db)
        return user
...
class Account(AbstractBaseUser):
    ...
    last_login   = models.DateTimeField(auto_now=True)   # ✅ fixed
    ...
    def has_module_perms(self, app_label):   # ✅ fixed parameter name
        return True
...
class UserProfile(models.Model):
    ...
    country = models.CharField(max_length=20, blank=True, null=True)   # ✅ नया field
